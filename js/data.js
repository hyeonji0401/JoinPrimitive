...
const qnaList = [
  {
    ...
    a: [
      ...
      { answer: ' 아 몰라~ 내일 끌리는 걸로!! ', type: ['0','1','2','3','6','9','11'] },
  ...
  },
  {
    q: '  드디어 개강 날이다! \n 첫 대학교 등굣길, 지금 내 생각은?  ',
    a: [
      { answer: ' 벌써 집에 가고 싶다... ', type: ['0','1','2','3','6','9'] },
  ...
  },
  {
    q: '  여기가 공주대구나! \n 학교 도착! \n 강의실로 가려는데 어떻게 가지?  ',
    a: [
      { answer: ' 이미 다 에타로 알아놨지~ ', type: ['1','3','4'] },
  ...
  },
  {
    ...
    a: [
      { answer: '마이쮸를 건네며, "안녕하세요!" 반갑게 인사한다 ', type: ['3','4','5','7','8','11' ] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'OT여도 수업은 수업. 빡공 시작한다', type: ['0','3','6'] },
    ]
  },

  {
    ...
    a: [
      ...
      { answer: '누군가는 하겠지...(나는 아님)', type: ['0','1','2','3','4','5','6','8','9','11' ] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: '집(또는 기숙사)으로 간다', type: ['0','1','2','3','5','6','9','11' ] },
    ]
  },
  {
    q: '  꼬르륵~ 점심시간이다. \n 아직 같이 먹을 사람이 없다. \n 이때 나는?  ',
    a: [
      { answer: '...(조용히 혼자 눈치 안 보고 밥 먹기 시작)', type: ['0','1','2','3','4','5','6','11' ] },
  ...
  },
  {
    ...
    a: [
      { answer: '(첫인상이 중요하지) \n 당차게 인사하며 동아리방에 들어간다', type: ['3','4','7','8','9'] },
  ...
  },
  {
    ...
    a: [
      { answer: '안녕하세요! 24학번 ㅇㅇ학과 ㅇㅇㅇ입니다!', type: ['1','3','4','8'] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: '아 정말 내 스타일이었지... \n (생각만 하고 집에 간다)', type: ['0','1','2','3','5','6','9','11'] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: '피곤했다... 얼른 집에 가서 자야지', type: ['0','1','2','3','5','6','9','11'] },
