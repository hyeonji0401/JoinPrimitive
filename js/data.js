...
const qnaList = [
  ...
  {
    q: '열심히 길을 찾아 강의실에 도착하고 빈자리에 앉았다. \n 강의실에서 처음으로 만난 옆자리 사람에게 나는?',
    a: [
  ...
  {
    q: '교수님이 강의실로 들어오시고 OT가 시작했다. \n 그런데!! 첫날부터 교수님이 풀강을 하시려는 낌새가 보인다,,,',
    a: [
  ...
  {
    q: '꼬르륵~ 점심시간이다. \n 밥을 먹어야 하는데 아직 친구를 사귀지 못해 같이 먹을 사람이 없다. 이때 나는?',
    a: [
  ...
  {
    q: 'PRIMITIVE 동아리방에 들어가자 선배들이 반갑게 맞아주신다! 그때 나는? ',
    a: [
  ...
  {
    q: '알고 보니 동아리 신청은 온라인으로만 이루어진다고 한다!! \n 그렇게 PRIMITIVE 동아리방에서 나오는 길, 사실 동아리방에서 첫눈에 반한 선배가 있었다,,, ',
    a: [
  ...
  {
    q: '그렇게 개강 첫날 모든 일정이 끝나고 집으로 돌아가는 길,,,',
    a: [
